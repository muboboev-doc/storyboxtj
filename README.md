...
Полная спецификация — [`docs/tz.md`](./docs/tz.md). Архитектурный обзор — [`docs/architecture.md`](./docs/architecture.md).
...
- 🟡 **Phase 0.5–0.10** — OpenAPI / Sentry / Filament admin / seed data / staging deploy
